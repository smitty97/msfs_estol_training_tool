// Toolbar chrome for the eSTOL Training panel.
//
...
// and polling the eSTOL Training Tool desktop app's local status server -
...
class IngamePanelEstolTraining extends TemplateElement {
    constructor() {
        super(...arguments);
    ...
    connectedCallback() {
        ...
        this.iframeElement = document.getElementById("eSTOLTrainingPanelIframe");
        ...
        if (this.ingameUi) {
            this.ingameUi.addEventListener("panelActive", function () {
                ...
                if (self.iframeElement) {
                    ...
                    self.iframeElement.src = "/InGamePanels/eSTOLTrainingPanel/panel.html";
                }
            });
...
window.customElements.define("ingamepanel-estol-training", IngamePanelEstolTraining);
checkAutoload();
